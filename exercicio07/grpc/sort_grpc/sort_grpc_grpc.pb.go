...
type SortServiceClient interface {
	...
	MergeSortAsync(ctx context.Context, in *SortRequest, opts ...grpc.CallOption) (*SortResponse, error)
	QuickSortAsync(ctx context.Context, in *SortRequest, opts ...grpc.CallOption) (*SortResponse, error)
}
...
func (c *sortServiceClient) MergeSortAsync(ctx context.Context, in *SortRequest, opts ...grpc.CallOption) (*SortResponse, error) {
	out := new(SortResponse)
	err := c.cc.Invoke(ctx, "/sort_grpc.SortService/MergeSortAsync", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sortServiceClient) QuickSortAsync(ctx context.Context, in *SortRequest, opts ...grpc.CallOption) (*SortResponse, error) {
	out := new(SortResponse)
	err := c.cc.Invoke(ctx, "/sort_grpc.SortService/QuickSortAsync", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SortServiceServer interface {
	...
	MergeSortAsync(context.Context, *SortRequest) (*SortResponse, error)
	QuickSortAsync(context.Context, *SortRequest) (*SortResponse, error)
...
func (UnimplementedSortServiceServer) MergeSortAsync(context.Context, *SortRequest) (*SortResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MergeSortAsync not implemented")
}
func (UnimplementedSortServiceServer) QuickSortAsync(context.Context, *SortRequest) (*SortResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method QuickSortAsync not implemented")
}
...
func _SortService_MergeSortAsync_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SortRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SortServiceServer).MergeSortAsync(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sort_grpc.SortService/MergeSortAsync",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SortServiceServer).MergeSortAsync(ctx, req.(*SortRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _SortService_QuickSortAsync_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SortRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SortServiceServer).QuickSortAsync(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sort_grpc.SortService/QuickSortAsync",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SortServiceServer).QuickSortAsync(ctx, req.(*SortRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SortService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "MergeSortAsync",
			Handler:    _SortService_MergeSortAsync_Handler,
		},
		{
			MethodName: "QuickSortAsync",
			Handler:    _SortService_QuickSortAsync_Handler,
		},
	},
